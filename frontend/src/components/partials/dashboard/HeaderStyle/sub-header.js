...
//img
import topHeader from '../../../../assets/images/dashboard/top-header5.png'
import topHeader1 from '../../../../assets/images/dashboard/top-header5.png'
                        ...
                        <Col md="12">
                            <div className="d-flex justify-content-between flex-wrap">
                                ...
                                <div className='mt-3' style={{
                                  ...
                                  <h1>New Testament Priests Church</h1>
