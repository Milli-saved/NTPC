      ...
      <div className="d-grid gap-3 grid-cols-2 mb-4">
        <div>
          ...
          <div className="form-group mb-0 custom-choicejs">
            <select
              ...
              onChange={(e) => dispatch(body_font_family(e.target.value))}
              value={
                props.bodyFontFamily !== null ? props.bodyFontFamily : "Inter"
              }
            >
        ...
        <div>
          ...
          <div className="form-group mb-0 custom-choicejs">
            <select
              className="form-control"
              onChange={(e) => dispatch(heading_font_family(e.target.value))}
              value={
