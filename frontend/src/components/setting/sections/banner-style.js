    ...
    <Fragment>
      <div>
        ...
        <div className="d-grid gap-3 grid-cols-3 mb-4">
          <RadioBtn
            btnName="header_banner"
            imgComponent={true}
            label="Color"
            className="text-center"
            labelclassName="p-0 d-block overflow-hidden"
            id="header-banner-color"
            defaultChecked={props.headerBanner}
            value="navs-bg-color"
          >
            <img
              src={image11}
          ...
          >
            ...
            <img
              ...
              loading="lazy"
            />
            <small className="badge bg-danger position-absolute top-1 end-0 m-2">
              Pro
            </small>
          </RadioBtn>
        </div>
