...
// img
import auth2 from '../../../assets/images/auth/08.png'
const Recoverpw = () => {
      ...
      <>
         <section className="login-content">
            <Row className="m-0 align-items-center bg-white vh-100">
               <Col md="6" className="d-md-block d-none bg-white p-0 mt-n1 vh-100 overflow-hidden" style={{
                  ...
                  <Card className="card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                     <Card.Body>
                        <Link to="/dashboard" className="navbar-brand d-flex align-items-center mb-3">
                           ...
                           <h4 className="logo-title ms-3">New Testament Priests Church</h4>
                        </Link>
                        ...
                        <Form>
                           ...
                           <Button className="mt-3" type="button" variant="primary">Reset</Button>
                        </Form>
                     </Card.Body>
                  </Card>
