  ...
  return (
    <Fragment>
      <Row>
              ...
              >
                ...
                <SwiperSlide className=" card card-slide">
                  <div className="card-body">
                    <div className="progress-widget">
                      ...
                      <div className="progress-detail">
                        <p className="mb-2">Church Branches</p>
                        <h4 className="counter">
                          <CountUp start={2} end={4} duration={3} />
                        </h4>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="progress-widget">
                      ...
                      <div className="progress-detail">
                        ...
                        <h4 className="counter">
                          <CountUp start={3} end={10} duration={3} />
                        </h4>
                      </div>
                    </div>
                  </div>
                ...
                <SwiperSlide className=" card card-slide">
                  <div className="card-body">
                    <div className="progress-widget">
                      ...
                      <div className="progress-detail">
                        <p className="mb-2">Online Members</p>
                        <h4 className="counter">
                          <CountUp
                            start={2}
                            end={1000}
                ...
                {/* <SwiperSlide className=" card card-slide">
                  <div className="card-body">
                    <div className="progress-widget">
                      <div>
                        <p>QR code of user is:</p>
                        <div
                          style={{ display: "flex", justifyContent: "center" }}
                        >
                          <QRCode size={150} value={member.member._id} />
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <Col md="12" className="col-centered">
          <Row>
            <Col md="12">
                ...
                <div className="flex-wrap card-header d-flex justify-content-between ">
                  ...
                  <div className="d-flex align-items-center align-self-center">
                    <div className="d-flex align-items-center text-primary">
                      ...
                      <div className="ms-2">
                        <span className="text-gray">Friday</span>
                      </div>
                    </div>
            ...
            <Col md="12" xl="12">
              <div className="card" data-aos="fade-up" data-aos-delay="900">
                <div className="flex-wrap card-header d-flex justify-content-between">
                  <div className="header-title">
                    <h4 className="card-title">Live Progress</h4>
                  </div>
                  <Dropdown>
                    <Dropdown.Toggle
                      as={Button}
                  ...
                  <div className="flex-wrap d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-grid gap col-md-4 col-lg-4">
                      ...
                      <div className="d-flex align-items-start">
                        ...
                        <div className="ms-3">
                          <span className="text-gray">Ushers</span>
                          <h6>25</h6>
                        </div>
                      </div>
                      <div className="d-flex align-items-start">
                        ...
                        <div className="ms-3">
                          <span className="text-gray">Naftalim</span>
                          <h6>15</h6>
                        </div>
                      </div>
                    </div>
