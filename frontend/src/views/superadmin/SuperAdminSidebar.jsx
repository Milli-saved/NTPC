...
const SuperAdminSidebar = memo((props) => {
      ...
      <Accordion as="ul" className="navbar-nav iq-main-menu">
        ...
        >
          ...
          >
            ...
            <span className="item-name">SA Dashboard</span>
          </Link>
        </li>
        <li>
        ...
        <li className="nav-item">
          <Link
            className={`${
              location.pathname === "/superadmin/addchurch" ? "active" : ""
            } nav-link`}
            to="/superadmin/addchurch"
          >
            <i className="icon">
              <svg
                width="20"
            ...
            <span className="item-name">Add Church</span>
          </Link>
        </li>
        <li className="nav-item">
          <Link
            className={`${
              location.pathname === "/superadmin/addadministrator" ? "active" : ""
            } nav-link`}
            to="/superadmin/addadministrator"
          >
            <i className="icon">
              <svg
                width="20"
            ...
            <span className="item-name">Add Adminstrator</span>
          </Link>
        </li>
