class SliderTab {
  ...
  resetSlider() {
    ...
    this.slider.style.width =
      this.element.querySelector(".nav-item:nth-child(1)").offsetWidth + "px";
  ...
  mouseOver() {
    this.element.onmouseover = (event) => {
      ...
      if (
        ...
        this.option.move !== undefined &&
        this.option.move === "hover"
      ) {
        this.updateSlide(item, items, index);
      } else {
        if (
          this.element.querySelector(
            ".nav-item:nth-child(" + index + ") .nav-link"
          ) !== null
        ) {
          this.element.querySelector(
            ".nav-item:nth-child(" + index + ") .nav-link"
  ...
  updateSlide(item, items, index) {
    ...
    if (this.element.classList.contains("flex-column")) {
      ...
      this.element
        .querySelector(".nav-item:nth-child(" + j + ")")
        .querySelector(".nav-link")
        .classList.add("active");
      this.slider.style.height = this.element.querySelector(
      ...
      this.element
        .querySelector(".nav-item:nth-child(" + index + ")")
        .querySelector(".nav-link")
        .classList.add("active");
      this.slider.style.width =
        this.element.querySelector(".nav-item:nth-child(" + index + ")")
          .offsetWidth + "px";
    }
  }
